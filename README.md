...
## Estructura del backend a entregar
...
#### Proyecto que contiene el Back-end para un aplicativo de gestión de eventos, a través del cual se pueden administrar las distintas entidades tales como usuarios, eventos, reservas, etc.
